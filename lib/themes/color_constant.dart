...
class ColorConstant {
  ...
  static Color blueGray90001 = fromHex('#302e2a');
  ...
  static Color green50 = fromHex('#eaf7f0');

  static Color indigo100 = fromHex('#b4c6e9');

  static Color Green = fromHex('#F5F5F5');

  static Color backgroundGreen = fromHex('#DAF2E5');

  static Color darkGrey = fromHex('#302E2A');

  static Color lightGray = fromHex('#807964');

  static Color plainGrey = fromHex('#D9D9D9');
